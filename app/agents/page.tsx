...
import { getAgentDefinitions } from "@/lib/agents/queries";
import { requireUser } from "@/lib/auth/require-user";
import { formatDate } from "@/lib/projects/format";

export const metadata: Metadata = {
  title: "Agents | MintChipOS",
};
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Specialized agent definitions and their current versions.
            </p>
          </div>
          ...
          {agents.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-zinc-300 bg-white p-10 text-center dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                Seeded agent definitions will appear here.
              </p>
            </div>
          ) : (
                  ...
                  <li key={agent.id}>
                    ...
                    >
                      ...
                      <div className="flex shrink-0 gap-3 text-sm text-zinc-500 dark:text-zinc-400">
                        <span>v{agent.current_version_number ?? "—"}</span>
